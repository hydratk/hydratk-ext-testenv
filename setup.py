...
config = {
    ...
    'files': {
        ...
        'data': {
            ...
            'tests/yodalib/hydratk/extensions/testenv/gui_int.py': '{0}/hydratk/yoda/lib/yodalib/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            ...
            'tests/yoda-tests/hydratk/extensions/testenv/smoke.jedi': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            'tests/yoda-tests/hydratk/extensions/testenv/sys_db.jedi': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            'tests/yoda-tests/hydratk/extensions/testenv/sys_rest.jedi': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            'tests/yoda-tests/hydratk/extensions/testenv/sys_soap.jedi': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            'tests/yoda-tests/hydratk/extensions/testenv/sys_gui.jedi': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            'tests/yoda-tests/hydratk/extensions/testenv/int_rest.jedi': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            'tests/yoda-tests/hydratk/extensions/testenv/int_soap.yoda': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR),
            'tests/yoda-tests/hydratk/extensions/testenv/int_gui.jedi': '{0}/hydratk/yoda/yoda-tests/hydratk/extensions/testenv'.format(syscfg.HTK_VAR_DIR)
        },
